...
//   const owner = 'facebook'; // Replace with your GitHub repo owner
//   const repo = 'react'; // Replace with your GitHub repo name
...
//         // Collect file content for each file
//         const fullRepoContent = await Promise.all(filesData.map(async (file) => {
//           if (file.type === 'file') {
...
//         setRepoContent(fullRepoContent.join('\n'));
